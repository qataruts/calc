 ...
 * `METHOD.md §٨`، بلاغُ العائلة `wasl-hamza-and-shared-bank-defects`): «الْمَسْ» لا
 * «اِلْمَسْ» · «اثْنَانْ» لا «اِثْنَانْ».
 *
...
function selfTest() {
  ...
  check(!vowelledWasl('اثْنَانْ') && !vowelledWasl('انْظُرْ') && !vowelledWasl('الْمَسْ'),
