...
def main() -> int:
    ...
    ap.add_argument("--timeout", type=int, default=780, help="ثوانٍ قبل الاستسلام — وُسّعت ٦٢٠←٧٨٠ بقرارٍ معلن (مراجعة م٦ + بلاغ العائلة busy-machine-false-reds: العتبةُ وُضعت لجهازٍ هادئ، وجولةُ م٦ زادت ~١٣ث)")
