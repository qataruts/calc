...
export function firstRunCard() {
  /* **ومعفاةٌ في المعاينة** (حكمُ المدير — الجلسة ط): كشريط التثبيت (`main.js`)،
     **وبعلّةٍ أقوى**. شريطُ التثبيت يُعفى لأنّ شريطين فوق الشاشة ضجيجٌ على المقيّم؛
     وهذه تُعفى لأنّ **المعاينةَ لا تكتب على القرص** (`save()` في `progress.js` بلا
     أثرٍ حين `PREVIEW`) — فالرحلةُ فيها **بكرٌ أبداً** مهما مشى فيها المقيّم، فشرطُ
     البطاقة متحقّقٌ في كل فتحة. **فلا تُخفى أبداً**: تظهر في لقطاتنا وفي جولات
     القياس وفي كل معاينةٍ يفتحها معلّم — **فتكذب صورتُنا على المنشور** وتَعِد بشريطٍ
     يراه الطفلُ مرّةً واحدة أنّه دائمُ الحضور. والمعاينةُ عرضٌ لبالغٍ يطّلع، لا
     جهازُ طفلٍ يُثبَّت عليه ولا رحلةٌ بكرٌ تُستأنف. */
