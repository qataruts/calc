...
const LANDMARKS = {
  ...
  // وعاءان متساويان بينهما سهمان يفترقان — معلمُ محطات «القسمة بالعدل» (المرحلة ١٠).
  // ولا ميزانَ هنا: الميزانُ معلمُ **المقارنة** (سواءٌ أم لا)، وهذا **توزيعٌ يقع**.
  share: '<path d="M32 6v10"/><path d="M32 16 18 26M32 16l14 10"/>'
    + '<path d="M6 28h20l-4 12H10z"/><path d="M38 28h20l-4 12H42z"/><path d="M4 44h56"/>',
  // مسطرةٌ بعلاماتها المتساوية — معلمُ محطات «القياس بوحدة» (المرحلة ١١)
  ruler: '<rect x="6" y="18" width="52" height="18" rx="3"/>'
    + '<path d="M17 18v8M28 18v11M39 18v8M50 18v11"/><path d="M6 44h52"/>',
