...
const ASK = {
  ...
  /* **ودعوةُ العدّ هي دعوتُه في ٢·١ بلفظها**: «اِلْمَسْ وَعُدَّ» تعلّمها الطفلُ على
...
function nameRound(station, rnd, { face, aided = false } = {}) {
  ...
  return {
    ...
    face,
    ask: ASK[face],
    hint: 'اُنْظُرْ إِلَى الأَشْكَال، ثُمَّ الْمَسِ الَّذِي سَمِعْتَ اسْمَه',
    options,
    figures: options,
...
function sidesRound(station, rnd, { face, aided = false } = {}) {
  ...
  return {
    ...
    face,
    ask: ASK.sides,
    hint: 'الْمَسْ كُلَّ ضِلْعٍ مَرَّةً وَاحِدَة',
    board,
    options,
