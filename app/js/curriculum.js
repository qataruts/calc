...
export const SHAPES_WORLD = [
  ...
  },
  {
    ...
    name: 'شَجَرَة',
    parts: [
      { shape: 'triangle', x: 0.08, y: 0.02, w: 0.84, h: 0.56 },   // التاج
      // **والثمرةُ داخل التاج لا على حافّته**: موضعُها محسوبٌ على عرض المثلث عند
      // أعلاها (مراجعةٌ بصرية على لوح `?dev=1#/render/shape`) — فتُقرأ ثمرةً لا قرصاً
      // معلَّقاً خارج الشجرة.
      { shape: 'circle', x: 0.42, y: 0.32, w: 0.25, h: 0.25 },     // ثَمَرة
      { shape: 'rect', x: 0.375, y: 0.58, w: 0.25, h: 0.40 },      // الجِذع
    ],
  },
  {
    id: 'boat',
