...
/**
 * **رحلةٌ بكر**: لا نجمةَ كُسبت ولا محاولةَ سُجّلت في ليتنر (الجلسة د٣ — شرطُ بطاقة
 * أول تشغيل).
 *
 * **ومحسوبةٌ من السجلّ لا عَلَماً يُكتب**: العَلَمُ يُكتب مرّةً ثم تتبدّل الرحلةُ تحته
 * (استعادةُ نسخةٍ · امتحانُ لحاقٍ يفتح · محوُ محطة) فيبقى يقول ما لم يعد صحيحاً —
 * والنجومُ والمهاراتُ تقولان الحقَّ متى سُئلتا. (وهي علّةُ «ما يُحسَب يعود بنفسه».)
 *
 * **والمحاولةُ تُعَدّ ولو لم تُصِب**: مدخلُ المهارة يُكتب بأوّل محاولةٍ — خاطئةً كانت
 * أو معانةً — فمن لعب فأخطأ ليس بكراً وإن لم يكسب نجمة. **والسؤالُ يبدأ بالأرخص**:
 * سجلُّ مهارةٍ واحد يكفي جواباً، فلا تُمسَح العقدُ كلُّها لمن يمشي منذ أسبوع.
 */
export function untouched() {
  return skills().length === 0 && totalStars() === 0;
}
